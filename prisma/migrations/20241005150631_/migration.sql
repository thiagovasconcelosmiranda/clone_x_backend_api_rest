...
-- AddForeignKey
ALTER TABLE "Tweet" ADD CONSTRAINT "Tweet_userStlug_fkey" FOREIGN KEY ("userStlug") REFERENCES "User"("slug") ON DELETE RESTRICT ON UPDATE CASCADE;
