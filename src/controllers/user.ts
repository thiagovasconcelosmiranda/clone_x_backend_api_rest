...
import {
    checkIfFollows, findUserBySlug, follow, getUserFollowersCount,
    getUserFollowingCount, getUserTweetCount, unfollow, UpdateUserInfo,
    userUploadAvatar, userUploadCover, getUserFollower
} from "../services/user";
...
export const getUser = async (req: ExtendedRequest, res: Response) => {
    ...
    const follows = await getUserFollower(slug);
    ...
    res.json({ user, followingCount, followersCount, tweetCount , follows});
}
